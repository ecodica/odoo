...
_SAFE_QWEB_OPCODES = _EXPR_OPCODES.union(to_opcodes([
    ...
    'SWAP',
    'POP_JUMP_FORWARD_IF_NOT_NONE', 'POP_JUMP_BACKWARD_IF_NOT_NONE',  # 3.11
    'POP_JUMP_FORWARD_IF_NONE', 'POP_JUMP_BACKWARD_IF_NONE',  # 3.11
    'POP_JUMP_BACKWARD_IF_TRUE',  # 3.11
    'JUMP_BACKWARD_NO_INTERRUPT',  # 3.11
    'CHECK_EXC_MATCH', 'CHECK_EG_MATCH',  # 3.11 added. It is a no-op.
